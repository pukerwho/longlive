...
<div id="comments">
  ...
  <div class="text-lg text-gray-600 italic mb-4">Is there anything to add?</div>
	<div>
		<?php
		comment_form(array(
			'title_reply' => '',
			'class_submit' => 'bg-blue-500 text-center text-gray-100 rounded cursor-pointer px-6 py-2 mb-4'
		));
		?>	
	</div>
